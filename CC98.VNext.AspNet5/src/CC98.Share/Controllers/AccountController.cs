...
namespace CC98.Share.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		/// </summary>
		[FromServices]
		public ExternalSignInManager ExternalSignInManager { get; set; }

		/// <summary>
		/// 提供添加和检索网页消息的功能。
		/// </summary>
		[FromServices]
		public IOperationMessageAccessor MessageAccessor { get; set; }
		...
		{
			// 目前直接跳转到当前用户的详细资料页面
			return RedirectToAction("Detail", "User", new { name = User.GetUserName() });
		}
	}
}
